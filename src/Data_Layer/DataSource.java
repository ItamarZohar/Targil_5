...
public class DataSource {
    ...
    static {
        try {
            ...
            allOrders = readOrdersfromFile();  //problem
            allProducts = readProductsfromFile(); //problem
    ...
    public static List<Customer> readCustomersfromFile() throws IOException {
        ...
        return Files.lines(Paths.get(customersPath)).map(Customer::new).collect(Collectors.toList());
    }
    ...
    public static List<Product> readProductsfromFile() throws IOException {
        return Files.lines(Paths.get(productsPath)).map(Product::new).collect(Collectors.toList());
    }

    public static List<OrderProduct> readOrderProductsfromFile() throws IOException {
        return Files.lines(Paths.get(orderProductPath)).map(OrderProduct::new).collect(Collectors.toList());
    }
}
